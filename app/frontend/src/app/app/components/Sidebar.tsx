...
const Sidebar: React.FC = () => {
  ...
  return (
    <div className="hidden lg:fixed bg-gray-900 min-h-screen lg:flex flex-col justify-between w-[250px] grow p-10 max-md:pb-24 max-md:px-5">
      ...
      <div className="items-start self-center flex w-[105px] max-w-full flex-col max-md:mt-10">
        ...
        <Link
          href="/app/explore"
          className={`text-xl font-bold self-stretch cursor-pointer whitespace-nowrap mt-16 max-md:mt-10 ${
            pathname === '/app/explore' ? 'text-violet-700' : ''
          }`}
        >
          Explore
        </Link>
