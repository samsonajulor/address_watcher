...
const Footer = () => {
  return (
    <div className="justify-center items-center bg-gray-950 self-stretch flex w-full flex-col px-20 pt-16 pb-8 border-t-zinc-500 border-t-opacity-50 border-t border-solid max-md:max-w-full max-md:px-5 max-md:py-24 max-sm:p-8">
      <div className="items-start self-center flex mb-0 w-full flex-col max-md:max-w-full max-md:mb-2.5">
            ...
            <div className="flex flex-col items-stretch w-[36%] max-md:w-full max-md:ml-0">
              <div className="items-start flex flex-col max-md:mt-10">
                <div className="items-start self-stretch flex flex-col">
                  <div className="text-4xl text-white self-stretch whitespace-nowrap max-md:text-3xl max-sm:text-xl">
                    Watcher
                  </div>
                ...
                <div className="gap-5 flex max-md:flex-col max-md:items-stretch max-md:gap-0">
                    ...
                    <div className="items-start flex w-full grow justify-start gap-20 max-md:mt-10 max-sm:mt-0">
                      <div className="items-start self-stretch flex flex-col">
                        ...
                        <div className="items-start self-stretch flex grow flex-col mt-10 max-sm:mt-7 max-sm:text-sm">
                          <div className="text-white self-stretch whitespace-nowrap">Home</div>
                      ...
                      <div className="items-start self-stretch flex flex-col">
                        ...
                        <div className="items-start self-stretch flex grow flex-col mt-10 max-sm:mt-7 max-sm:text-sm">
                          <div className="text-white self-stretch whitespace-nowrap">Lorem</div>
                          <div className="text-white self-stretch whitespace-nowrap mt-8 max-sm:mt-5">
                            Ipsum
                          </div>
                          <div className="text-white self-stretch whitespace-nowrap mt-8 max-sm:mt-5">
                  ...
                  <div className="flex flex-col items-stretch w-[58%] ml-5 max-md:w-full max-md:ml-0">
                    <div className="items-start flex flex-col max-md:mt-10">
                      ...
                      <input
                        type="email"
                        className="border outline-none pl-4 text-white bg-gray-900 bg-opacity-50 self-stretch flex w-full h-[48px] flex-col mt-10 rounded-lg border-solid border-gray-600 max-sm:mt-5 max-sm:h-[36px] max-sm:text-sm"
                      />
                    </div>
                  </div>
                </div>
        ...
        <div className="justify-center items-center self-stretch flex grow flex-col mt-16 pt-9 px-20 border-t-zinc-500 border-t-opacity-50 border-t border-solid max-md:max-w-full max-md:mt-10 max-md:px-5">
          <div className="text-violet-700 text-center self-center whitespace-nowrap max-sm:text-xs">
