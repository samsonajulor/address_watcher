...
const Info = ({ title, items }: { title: string; items: string[] }) => {
  return (
    <div className="flex flex-col w-full max-md:w-full max-md:ml-0">
      <div className="card justify-center items-center flex grow flex-col w-[80%] mx-auto px-9 py-14 rounded-[32px] max-md:max-w-full max-md:mt-10 max-md:px-5 max-md:py-24 max-sm:py-8 max-sm:rounded-[16px]">
