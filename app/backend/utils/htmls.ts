...
export const valueTx = (value: string, tx: any) => {
  return `
  <!DOCTYPE html>
<html lang="en">
  <head>
...
export const interaction = (value: string, others: any, tx: any) => {
  return `
  <!DOCTYPE html>
<html lang="en">
  <head>
                  ...
                  <tr>
                    <td style="padding: 0 35px">
                      ...
                      <ul style="list-style: none; color: #455056; width: 80vw; text-align: left">
                        ...
                        <li style="margin-top: 5px"><span style="font-weight: 600">Function signature:</span> ${
                          others.sig
                        }</li>
                        <li style="margin-top: 5px"><span style="font-weight: 600">Amount:</span> ${ethers.formatEther(
                          tx.value
...
export const transaction = (value: string, others: any, tx: any) => {
  return `
  <!DOCTYPE html>
<html lang="en">
  <head>
