  ...
  return (
    <div>
      <div className="gap-5 flex max-md:flex-col max-md:items-stretch max-md:gap-0">
        ...
        <div className="flex flex-col items-stretch w-full mx-10 max-md:w-full max-md:ml-0">
          <div className="justify-center items-center bg-gray-950 flex grow flex-col w-full mx-auto pt-20 pb-80 px-20 max-md:max-w-full max-md:pb-24 max-md:px-5">
            <div className="justify-between items-start self-center flex w-full gap-5 max-md:max-w-full max-md:flex-wrap">
              <input
                className="text-zinc-500 text-lg self-stretch outline-none whitespace-nowrap items-center border bg-gray-900 bg-opacity-20 w-[383px] max-w-full pl-4 pr-20 py-5 rounded-lg border-solid border-gray-500 max-md:pr-5"
            ...
            <div className="justify-between items-start self-center flex w-full gap-5 mt-24 pr-1 max-md:max-w-full max-md:flex-wrap max-md:mt-10">
              <div className="text-violet-600 text-3xl self-stretch grow shrink basis-auto">
              ...
              <div className="justify-between items-start self-stretch flex gap-2">
                ...
                />
                <div
                  className="text-orange-400 text-2xl self-center whitespace-nowrap my-auto cursor-pointer"
